...
>
        ...
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>نئے فرد کا اندراج کریں</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>کسی فرد کی معلومات میں تبدیلی کریں</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.button}>
          <Text style={styles.buttonText}>کسی فرد کی معلومات کو مٹا دیں</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
